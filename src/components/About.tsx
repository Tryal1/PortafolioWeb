        ...
        <section id="sobre mi" className="min-h-screen pt-32 pb-20 px-8 max-w-7xl mx-auto flex flex-col md:grid md:grid-cols-12 gap-12 items-center">
            <div className="md:col-span-7 z-10">
                <h1 className="font-headline text-4xl md:text-7xl font-extrabold tracking-tight leading-none mb-8 text-glow">
                    {t('about.title')}
                    <br />
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">{t('about.subtitle')}</span>
                </h1>
                ...
                <div className="flex flex-wrap gap-4">
                    ...
                    <a href={i18n.resolvedLanguage === 'es' ? "/Thomas_Carreno.pdf" : "/Thomas_Carreno_Ingles.pdf"} download className="bg-surface-container-high/40 backdrop-blur-md text-on-surface font-bold px-8 py-4 rounded-xl border border-outline-variant/30 hover:bg-surface-container-high transition-all cursor-pointer">
                        {t('about.btn_cv')}
                    </a>
                </div>
            </div>
