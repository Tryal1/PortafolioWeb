...
const Education = () => {
    return (
        <section id="educacion" className="py-24 max-w-7xl mx-auto px-8">
            <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                    ...
                    <a key={i} target='_blank' href={edu.href} className="cursor-pointer flex flex-col group bg-surface-container-high rounded-xxl overflow-hidden border border-white/5 transition-all duration-500 hover:-translate-y-2">
                        <div className="min-h-64 overflow-hidden relative">
                            <img alt={edu.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 opacity-40" src={edu.img} />
                        </div>
